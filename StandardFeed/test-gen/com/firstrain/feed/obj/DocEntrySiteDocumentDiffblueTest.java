...
public class DocEntrySiteDocumentDiffblueTest {
  ...
  @Test
  public void attributesOutputNull() throws Exception {

    // Arrange
    final DocEntrySiteDocument objectUnderTest =
        (DocEntrySiteDocument) Reflector.getInstance("com.firstrain.feed.obj.DocEntrySiteDocument");
    Reflector.setField(objectUnderTest, "summary", null);
    objectUnderTest.setInsertTime(null);
    Reflector.setField(objectUnderTest, "attributes", null);
    Reflector.setField(objectUnderTest, "docCatObjs", null);
    objectUnderTest.setGroupID(0L);
    objectUnderTest.setTitle(null);
    objectUnderTest.setSiteDocID(0L);
    objectUnderTest.setOriginalDocEntry(null);

    // Act
    final Map<String, Object> retval = objectUnderTest.attributes();
  ...
  // Test generated by Diffblue Deeptest.
  @PrepareForTest({
    FR_IDocCategory.class,
    EntityEntry.class,
    DocEntrySiteDocument.class,
    DocCatEntry.class
  })
  @Test
  public void setDocCatEntriesInput1OutputVoid4() throws Exception {

    // Arrange
    final DocEntrySiteDocument objectUnderTest =
        (DocEntrySiteDocument) Reflector.getInstance("com.firstrain.feed.obj.DocEntrySiteDocument");
    Reflector.setField(objectUnderTest, "summary", "");
    objectUnderTest.setInsertTime(null);
    Reflector.setField(objectUnderTest, "attributes", null);
    final ArrayList<FR_IDocCategory> arrayList = new ArrayList<FR_IDocCategory>();
    Reflector.setField(objectUnderTest, "docCatObjs", arrayList);
    objectUnderTest.setGroupID(0L);
    objectUnderTest.setTitle(null);
    objectUnderTest.setSiteDocID(0L);
    final DocEntry docEntry =
        (DocEntry) Reflector.getInstance("com.firstrain.solr.client.DocEntry");
    Reflector.setField(docEntry, "sitedocId", null);
    Reflector.setField(docEntry, "title", null);
    Reflector.setField(docEntry, "summary", null);
    objectUnderTest.setOriginalDocEntry(docEntry);
    final ArrayList<DocCatEntry> docCatEntries = new ArrayList<DocCatEntry>();
    ...
    final Method isValidMethod = DTUMemberMatcher.method(EntityEntry.class, "isValid");
    PowerMockito.doReturn(true).when(entityEntry, isValidMethod).withNoArguments();
    final Method isExcludedMethod = DTUMemberMatcher.method(EntityEntry.class, "isExcluded");
    PowerMockito.doReturn(false).when(entityEntry, isExcludedMethod).withNoArguments();
    final Method getIdMethod = DTUMemberMatcher.method(EntityEntry.class, "getId");
    PowerMockito.doReturn("+5").when(entityEntry, getIdMethod).withNoArguments();
    ...
    docCatEntries.add(docCatEntry);
    final FR_DocCategory fR_DocCategory = PowerMockito.mock(FR_DocCategory.class);
    PowerMockito.whenNew(FR_DocCategory.class).withNoArguments().thenReturn(fR_DocCategory);

    // Act
    objectUnderTest.setDocCatEntries(docCatEntries);
  }
}
