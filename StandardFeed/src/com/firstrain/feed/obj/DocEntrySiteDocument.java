...
public class DocEntrySiteDocument implements FR_ISiteDocument {
	...
	protected DocEntry originalDocEntry;
	private Timestamp insertTime;
	private Map<String, Object> attributes = new HashMap<String, Object>();
	private long groupId;
	private ArrayList<FR_IDocCategory> docCatObjs = new ArrayList<FR_IDocCategory>();

	public DocEntrySiteDocument(DocEntry docEntry) {
		this.title = docEntry.title;
		this.summary = docEntry.summary;
		...
		this.groupId = docEntry.getGroupId();
		setDocCatEntries(docEntry.getCatEntries());
	}
	...
	@Override
	public void setDocCatObjs(ArrayList docCatEntries) {
		// TODO Auto-generated method stub

	}

	public void setDocCatEntries(List<DocCatEntry> docCatEntries) {
		for (DocCatEntry docCat : docCatEntries) {
			EntityEntry entity = docCat.getEntity();
			if (entity != null && entity.isValid() && !entity.isExcluded()) {
				int entityId = Integer.parseInt(entity.getId());
				FR_IDocCategory fr_IDocCategory = new FR_DocCategory();
				fr_IDocCategory.setCatID(entityId);
				this.docCatObjs.add(fr_IDocCategory);
			}
		}
